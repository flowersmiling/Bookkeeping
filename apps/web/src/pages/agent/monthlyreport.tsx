...
const monthlyreport = () => {
  ...
  const [columnDefs] = useState([
    {
      ...
      children: [
        {
          headerName: 'Landlord Property Monthly Statement',
          children: [
            {
              field: 'rent_date',
        ...
        },
        {
          ...
          children: [
            ...
            { field: 'cra', width: 100, headerName: 'CRA' },
  ...
  const loadData = (params: Date) => {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/adminreport/63edb7daa1aa1b5b05ef1ecf/${year}/${month}`
    )
      .then((resp) => resp.json())
